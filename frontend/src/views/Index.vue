    ...
    <div class="body">
      ...
      <div class="container-input">
        <div class="text-input">
          <input type="text" name="" v-model="userChat" :placeholder="placeholder" @keydown="($event) => { if ($event.keyCode === 13) { sendChat() } }" @focus="alert">
...
export default {
  ...
  data () {
    return {
      ...
      // {
      //   isBot: true,
      //   content: '딸꾹질(hiccup, singultus)은 횡격막이 경련수축을 일으켜서 성문이 열리고 성대가 닫혀 특징적인 소리를 내는 현상을 말한다. 딸꾹질은 짧고, 날카롭고, 매우 갑작스러운 호흡이다.',
      //   image: 'https://pds.joins.com/news/component/htmlphoto_mmdata/201504/02/htm_2015040218549c010c011.JPG',
      //   date: new Date()
      // }
      ]
    }
